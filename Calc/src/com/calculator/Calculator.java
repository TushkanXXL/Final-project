...
public class Calculator {
    ...
    private JButton btnC, btnBack, btnMod, btnDiv, btn7, btn8, btn9,
            btnMul, btn4, btn5, btn6, btnSub, btn1, btn2, btn3, btnAdd, btnPoint, btn0, btnEqual, btnRoot, btnPower,
            btnLog, btnSwitchToScientificMode;
    private char opt = ' ';
    ...
    private Calculator() {
        ...
        btnSwitchToScientificMode.setBounds(100, 30, 190, 18);
        btnSwitchToScientificMode.setText("Расширенный режим");
